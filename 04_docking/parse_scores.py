...
Output: scores_naive.csv and scores_skill.csv (columns: compound_id, score)
...
PROTOCOLS = {
    "naive": {
        "results_dir": BASE / "naive" / "results",
        "output_csv": BASE / "naive" / "scores_naive.csv",
    },
    "skill": {
        "results_dir": BASE / "skill" / "results",
        "output_csv": BASE / "skill" / "scores_skill.csv",
    },
}
